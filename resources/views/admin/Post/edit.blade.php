                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="review-content-section">
                                            <div class="row">
                                                ...
                                                <form action="/post/sua/{{$t->id}}" method="post" enctype="multipart/form-data">
                                                    <div class="col-lg-8">
                                                        <div class="devit-card-custom">
                                                            <div class="form-group CVV">
                                                                <input type="text" name="tieuDe" class="form-control"  value="{{$t->tieuDe}}">
                                                            </div>
                                                            <div class="form-group" id="card-number-field">
                                                                <textarea name="tomTat" class="form-control" rows="5" >{{$t->tomTat}}</textarea>
                                                            </div>
                                                            <div class="form-group" id="card-number-field">
                                                                <input type="text" name="ngayDang" class="form-control"  value="{{$t->ngayDang}}">
                                                            </div>
                                                            <select name="idLT" class="form-control mg-b-15">
                                                                @foreach ( $lt as $tl)
                                                                    @if ($tl->id == $t->idLT)
                                                                        <option selected value="{{$tl->id}}">{{$tl->tenmuc}}</option>
                                                                    @else
                                                                    <option value="{{$tl->id}}">{{$tl->tenmuc}}</option>
                                                                    @endif      
                                                                @endforeach
                                                            </select>
                                                            <div class="form-group" id="card-number-field">
                                                                <input type="text" name="xem" class="form-control"  value="{{$t->xem}}">
                                                            </div>
                                                            <div class="form-group" id="card-number-field">
                                                                <input type="text" name="active" class="form-control"  value="{{$t->active}}">
                                                            </div>
                                                            <div class="form-group" id="card-number-field">
                                                                <input style="color: white;" type="file" name="file_upload">
                                                            </div>
                                                            <img src="/uploads/{{$t->img}}" style="width: 50%;padding-bottom: 20px" alt="">
                                                            <div class="form-group" id="card-number-field">
                                                                <textarea name="noiDung" class="form-control" rows="20" id="editor">{{$t->noiDung}}</textarea>
                                                            </div>
