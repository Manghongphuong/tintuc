                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="review-content-section">
                                            <div class="row">
                                                ...
                                                <form action="/post/them" method="post" enctype="multipart/form-data">
                                                    <div class="col-lg-8">
                                                        <div class="devit-card-custom">
                                                            <div class="form-group CVV">
                                                                <input type="text" name="tieuDe" class="form-control" id="cvv" placeholder="Tiêu đề">
                                                            </div>
                                                            <div class="form-group" id="card-number-field">
                                                                <textarea name="tomTat" class="form-control" rows="5" id="cardNumber" placeholder="Tóm tắt"></textarea>
                                                            </div>
                                                            <div class="form-group" id="card-number-field">
                                                                <input type="text" name="ngayDang" class="form-control" id="cardNumber" placeholder="Ngày đăng">
                                                            </div>
                                                            ...
                                                            <div class="form-group" id="card-number-field">
                                                                <input type="text" name="xem" class="form-control" id="cardNumber" placeholder="Xem">
                                                            </div>
                                                            <div class="form-group" id="card-number-field">
                                                                <input type="text" name="active" class="form-control" id="cardNumber" placeholder="Trạng thái">
                                                            </div>
                                                            <div class="form-group" id="card-number-field">
                                                                <input style="color: white;" type="file" name="file_upload">
                                                            </div>
                                                            <div class="form-group" id="card-number-field">
                                                                <textarea name="noiDung" class="form-control" rows="20" id="editor"></textarea>
                                                            </div>
