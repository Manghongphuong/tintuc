                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="breadcomb-wp">
                                        ...
                                        <div class="breadcomb-ctn">
                                            <h2>Tin Tức</h2>
                                            <p>Xin chào<span class="bread-ntd">quản trị viên</span></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    ...
                    <div class="product-status-wrap">
                        ...
                        <table>
                            ...
                            @foreach ( $post as $list)
                                ...
                                <tr>
                                    <td><img src="../uploads/{{$list->img}}" alt=""></td>
                                    <td>{{$list->tieuDe}}</td>
                                    <td>{{$list->tomTat}}</td>
                                    ...
                                    <td>{{$list->xem}}</td>
                                    <td>
                                        <button class="ps-setting">{{$list->active}}</button>
                                    </td>
                                    <td>
                                        <button data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Edit"><a href="/post/sua/{{$list->id}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></button>
                                        <button data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Trash"><a href="/post/xoa/{{$list->id}}"><i class="fa fa-trash-o" aria-hidden="true"></i></a></button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody></table>
