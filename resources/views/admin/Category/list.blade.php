                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="product-status-wrap">
                        ...
                        <div class="add-product">
                            <a href="/dm/them">Thêm loại tin</a>
                        </div>
                        <table>
                            <tbody><tr>
                                <th>Loai tin</th>
                            ...
                            @foreach ( $list as $category)
                                <tr>
                                    <td>{{$category->tenmuc}}</td>
                                    <td>
                                        <button data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Edit"><a href="/dm/sua/{{$category->id}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></button>
                                        <button data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Trash"><a href="/dm/xoa/{{$category->id}}"><i class="fa fa-trash-o" aria-hidden="true"></i></a></button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
