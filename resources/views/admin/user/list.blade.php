                            ...
                            <tbody>
                                ...
                                @foreach ( $user as $tv)
                                    <tr>
                                        ...
                                        <td>{{$tv->password}}</td>
                                        <td>
                                            <button class="ds-setting">{{$tv->userType}}</button>
                                        </td>
                                        <td>
                                            <button data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Edit"><a href="/user/sua/{{$tv->id}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></button>
                                            <button data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Trash"><a href="/user/xoa/{{$tv->id}}"><i class="fa fa-trash-o" aria-hidden="true"></i></a></button>
                                        </td>
                                    </tr>
                                @endforeach
                        </tbody></table>
